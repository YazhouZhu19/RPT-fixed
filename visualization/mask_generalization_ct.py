...
cv2.imwrite("./data/Abd_CT/abd_ct_liver_img.png", abd_ct_img_show_1)        # the image 
...
cv2.imwrite("./data/Abd_CT/abd_ct_spleen_img.png", abd_ct_img_show_2)
...
cv2.imwrite("./data/Abd_CT/abd_ct_rk_img.png", abd_ct_img_show_3)
...
cv2.imwrite("./data/Abd_CT/abd_ct_lk_img.png", abd_ct_img_show_4)
